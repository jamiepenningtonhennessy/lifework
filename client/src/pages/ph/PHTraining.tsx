        ...
        <div className="container max-w-6xl">
          <div className="grid md:grid-cols-2 gap-14 items-start">
            ...
            >
              ...
              >
                In partnership with Qinect, I offer a suite of AI-driven role-play scenarios that allow professionals to practise difficult conversations in a psychologically safe environment. The learner is the protagonist; AI plays the other roles — consistently, realistically, and without judgment.
              </p>
              <p
                className="mb-6"
                style={{ fontSize: "0.88rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.8 }}
