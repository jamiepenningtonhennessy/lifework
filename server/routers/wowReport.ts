...
- Write directly to the client using "you" and "your" throughout — this report is addressed to them personally. Do not use the client's name where "you" reads more naturally. Use pronouns: ${pronouns}.
...
This section uses the Insights Discovery vocabulary (colour energies) to give a clear, evidence-based picture of how you tend to operate in professional settings. It is a tool for self-awareness and practical application, not a label.
...
Describe your primary (${primaryColour}) and secondary (${secondaryColour}) colour energies with precision. Explain what each energy means in practice — how it shows up in your communication style, decision-making, and relationships at work. Name the specific combination and what it produces. Where relevant, name the tension or paradox this combination creates.
...
Write directly to the client using "you" and "your" throughout. Do NOT include any introductory paragraph before the first ## heading. Do NOT use flattering or encouraging language.`;
  ...
  const [
    ...
    callLLMWithTimeout(sys,
      `${ctx}\n\nWrite an interpretive narrative for the client's top 7 VIA Character Strengths. Write directly to the client using "you" and "your" throughout. Begin IMMEDIATELY with the first strength — do NOT write any introductory paragraph, preamble, greeting, or scene-setting text before the first ## heading. For each strength, write 2-3 sentences: what it means in your specific context, and how it has shown up in your life history. Then write a 2-paragraph synthesis: how these strengths work together as a system, and what they mean for your career.`
    ),
    callLLMWithTimeout(sys,
      `${ctx}\n\nWrite an interpretive narrative of the client's Big Five personality profile. Write directly to the client using "you" and "your" throughout. Begin IMMEDIATELY with the heading "## Personality Profile: A Deep Dive" — do NOT write any introductory paragraph, preamble, or scene-setting text before this heading. Then for each of the five domains, write 2-3 sentences interpreting the score in the context of your career and life history. Then write a 2-paragraph "Working Style" synthesis: how you operate at your best, and what environments bring out the best in you.`
    ),
...
The three paragraphs together should be speakable in under 90 seconds. Each sentence must earn its place. This chapter should feel like the culmination of the whole report — the moment when everything Jamie has observed is distilled into a clear, committed statement of who you are.`
    ),
  ]);
