...
Write directly to the client using "you" and "your" throughout. Do NOT include any introductory paragraph before the first ## heading. Do NOT use flattering or encouraging language.`;
  ...
  const [
    ...
    callLLMWithTimeout(sys,
      `${ctx}\n\nWrite the Character Strengths chapter of the Lifework report. This chapter has three distinct movements. Write directly to the client using "you" and "your" throughout. Do NOT write any introductory paragraph before the first heading. Begin immediately with ## Your Top 5 Signature Strengths.\n\n## Your Top 5 Signature Strengths\nFor each of the top 5 VIA strengths in the data, write a short entry under a ### subheading (e.g. ### 1. Humor). Each entry must contain two things:\n- What this strength means: give the VIA definition in plain, direct language — not the clinical wording, but what it actually describes in a person. 2-3 sentences.\n- What it looks like in you: one concrete sentence connecting the strength to your specific context, role, or way of working.\nDo NOT reference the life history in this movement. The point is to establish what the instrument says about each strength on its own terms.\n\n## Where the Strengths Show Up\nThis is the analytical core of the chapter. For each of the top 5 strengths, examine the fulfilling achievements in the life history — the ones the client marked as most meaningful — and count how many of them show clear evidence of that strength.\n\nFor each strength, write a short entry under a ### subheading. The entry must:\n- State the frequency: how many of the fulfilling achievements show evidence of this strength (e.g. "Evidence appears in 4 of your fulfilling achievements")\n- Name the specific achievements where the evidence is clearest, and quote or closely paraphrase the specific detail that shows the strength\n- Be concrete and forensic: do not say "this strength is visible throughout your history" — name the exact moments\n\nThis movement should feel like a detective presenting evidence, not a coach offering encouragement.\n\n## What the Pattern Reveals\nThis is the interpretive synthesis. Write 3-4 paragraphs that:\n- Identify the most analytically significant finding: which strength has the highest frequency in fulfilling moments? Does this match its survey rank, or is there a divergence? Name the divergence explicitly if it exists.\n- Identify any strength where frequency and identity salience diverge: a strength that appears often but is never narrated as meaningful may be a trained behaviour rather than a true signature. A strength that appears rarely but shows up at pivotal moments may be the deepest organising value. Name these distinctions.\n- Name the 1-2 strengths that appear to be the deepest organising values — the ones that structure how you make choices, not just what you are good at.\n- Close with a single sentence that captures the most important thing this analysis reveals — something the survey rank alone would not have shown.`
    ),
    callLLMWithTimeout(sys,
